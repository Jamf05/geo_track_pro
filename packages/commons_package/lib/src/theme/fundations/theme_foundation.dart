...
/// Clase contenedora para los temas de la aplicación (light y dark).
/// Esta clase se utiliza en toda la aplicación a través de sus propiedades
/// estáticas lightTheme y darkTheme.
class ThemeFoundation {
  static final ThemeData lightTheme = ThemeData(
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: StylesFoundation.of(Brightness.light).elevatedButtonStylePrimaryA,
    ),
    /**
     * outlinedButtonTheme
     */
    outlinedButtonTheme: OutlinedButtonThemeData(
      style: StylesFoundation.of(Brightness.light).outlinedButtonStylePrimaryB,
    ),
    /*
      * titleMedium
      */
    ...
    dividerTheme: const DividerThemeData(
      color: ColorsToken.antiFlashWhite,
      space: 16,
    ),
    /**
     * floatingAction
  ...
  static final ThemeData darkTheme = ThemeData(
     ...
     */
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: StylesFoundation.of(Brightness.dark).elevatedButtonStylePrimaryB,
    ),
    /**
     * outlinedButtonTheme
     */
    outlinedButtonTheme: OutlinedButtonThemeData(
      style: StylesFoundation.of(Brightness.dark).outlinedButtonStylePrimaryB,
    ),
    /*
      * titleMedium
      */
